...
class TestMixProbExogPredictor(unittest.TestCase):
    ...
    def test_forward_shape(self):
        ...
        output = predictor(logits=concept_logits, exogenous=exogenous)
    ...
    def test_gradient_flow(self):
        ...
        concept_logits = torch.randn(2, 8, requires_grad=True)
...
class TestHyperLinearPredictor(unittest.TestCase):
    ...
    def test_custom_activation(self):
        ...
        concept_logits = torch.randn(2, 10)
    ...
    def test_sample_adaptive_weights(self):
        ...
        concept_logits = torch.ones(2, 5)  # Same concepts
        exogenous1 = torch.randn(1, 1, 32)
        exogenous2 = torch.randn(1, 1, 32)

        output1 = predictor(logits=concept_logits[:1], exogenous=exogenous1)
        output2 = predictor(logits=concept_logits[:1], exogenous=exogenous2)
