...
class TestProbabilisticModelGraph:
    def test_undirected_construction_and_factor_keys(self):
        ...
        pm = _ConcreteModel(variables=[a, b], factors=[pot])
    ...
    def test_adjacency_and_neighbors(self):
        ...
        pm = _ConcreteModel(variables=[a, b, c], factors=[p_ab, p_bc])
    ...
    def test_duplicate_factor_name_raises(self):
        ...
        with pytest.raises(ValueError, match="duplicate factor name"):
            _ConcreteModel(variables=[a, b], factors=[p1, p2])
...
class TestGraphKind:
    ...
    def test_is_directed(self):
        ...
        pm = _ConcreteModel(variables=[a, b], factors=[cpd_a, cpd_b])
    ...
    def test_is_mixed(self):
        ...
        pm = _ConcreteModel(variables=[a, b, c], factors=[cpd_a, cpd_b, cpd_c, pot])
        assert pm.is_mixed
