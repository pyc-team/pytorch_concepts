...
######################################################################
## Subsample the concepts to retain only 50% of the concepts (skip some numbers e.g. the concepts associated to the
## the right digit or some concepts with some probabilities)
...
if __name__ == "__main__":
    ...
    dataset = PartialMNISTAddition(root='./data', train=True)
    ...
    train_loader = DataLoader(train_set, batch_size=256, shuffle=True, num_workers=4, persistent_workers=True)
    val_loader = DataLoader(val_set, batch_size=256, shuffle=False, num_workers=4, persistent_workers=True)
    test_loader = DataLoader(test_set, batch_size=256, shuffle=False, num_workers=4, persistent_workers=True)
