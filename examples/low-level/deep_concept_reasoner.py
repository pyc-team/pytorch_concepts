...
def main():
    ...
    # it is the module predicting the concept importance for each concept for all classes for all roles
    # its input is B x C x E, where B is the batch size, C is the number of concepts, and E is the embedding size
    # its output is B x C x T x N, where T is the number of tasks and N is the number of roles
