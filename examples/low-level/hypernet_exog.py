...
from torch_concepts.nn import ExogEncoder, ProbEncoderFromEmb, HyperNetLinearPredictor
...
def main():
    ...
    y_predictor = HyperNetLinearPredictor(in_features_logits=c_annotations.shape[1],
    ...
    for epoch in range(n_epochs):
        ...
        y_pred = y_predictor(logits=c_pred, embedding=emb)
