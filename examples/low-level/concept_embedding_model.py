...
from torch_concepts.nn import ProbPredictor, ProbEmbEncoder
...
def main():
    ...
    y_predictor = ProbPredictor(cem_encoder.out_concept_features, y_annotations)
    model = torch.nn.Sequential(encoder, cem_encoder, y_predictor)
